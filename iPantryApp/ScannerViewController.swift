...
//
//          // 3
////            var potentialProduct = Product(barcode: potentialBarcode.symbology.rawValue)
////            potentialProduct.getData()
////            print(potentialProduct.response)
////            showAlert(withTitle: potentialProduct.response.products[0].product_name, message: potentialBarcode.payloadStringValue ?? "")
//          showAlert(
